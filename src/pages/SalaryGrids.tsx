                  ...
                  <tbody className="divide-y divide-slate-100">
                    {filtered.map((grid) => (
                      <tr key={grid.id} className="hover:bg-slate-50 transition-colors">
                        ...
                        <td className="px-4 py-3 text-sm text-right text-slate-600">{formatXOF(grid.hourly_rate)}/h</td>
        ...
        <div className="fixed inset-0 bg-slate-900/50 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md">
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-4">
              ...
              <div><label className="label">Taux horaire (FCFA/h)</label><input type="number" min="0" step="0.01" value={form.hourly_rate} onChange={(e) => setForm({ ...form, hourly_rate: Number(e.target.value) })} className="input" /></div>
